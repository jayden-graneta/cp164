...
class List:
    ...
    def remove_many(self, key):
        ...
        while target is not None and target._value == key:
            self._remove_front
            target = self._front
    ...
    def __getitem__(self, i):
        ...
        # your code here
        pevious, current, index = self._linear_search(self)
    ...
    def max(self):
        ...
        while curr is not None:
            if max_data < curr._value:
                max_data = curr._value
    ...
    def min(self):
        ...
        while curr is not None:
            if min_data > curr._value:
                min_data = curr._value
    ...
    def reverse_r_aux(self, prev, curr):
        if curr is None:
            self._front = prev
        else:
            temp = curr._next
            curr._next = prev
            self._reverse_r_aux(curr, temp)
        return
    ...
    def __eq__(self, target):
        ...
        if self._count != target._count:
            ...
            while curr1 is not None and equals:
                if curr1._values != curr2._values:
                    equals = False
                curr1 = curr1._next
                curr2 = curr2._next
    ...
    def split_alt(self):
        ...
        while self._front is not None:
            if left:
                self._move_front_to_rear(target1)
            else:
                self._move_front_to_rear(target2)
