...
class Sorts:
    ...
    def radix_sort(arr):
        ...
        Use: Sorts.radix_sort(arr)
        -------------------------------------------------------
        Parameters:
            arr - an array of base 10 integers (list)
        Returns:
            None
        -------------------------------------------------------
        """
    ...
    def gnome_sort(arr):
        ...
        -------------------------------------------------------
        Parameters:
            arr - an array of comparable elements (list)
        Returns:
            None
        -------------------------------------------------------
        """
        ...
        while not sorted_flag:
            if gnome_index == 0:
                if gnome_index >= len(arr) - 1:
                    sorted_flag = True
                else:
                    gnome_index += 1
            elif arr[gnome_index - 1] <= arr[gnome_index]:
                if gnome_index == len(arr) - 1:
                    sorted_flag = True
                else:
                    gnome_index += 1
            elif arr[gnome_index - 1] > arr[gnome_index]:
                Sorts._swap(arr, gnome_index, gnome_index - 1)
                gnome_index -= 1
